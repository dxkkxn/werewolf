...
router.post('/game', validateToken, validateBodyCreateGame, validateUserNotAlreadyInGame, createGame);

router.post('/game/:idGame', validateToken, validateIdGame, validateUserNotAlreadyInGame, joinGame);
...
router.post('/game/:idGame/message', validateToken, validateUserInGame, validateGameStarted, addMessage);
